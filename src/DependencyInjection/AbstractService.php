...
namespace ISerranoDev\CrudGenerator\DependencyInjection;
...
abstract class AbstractService extends EncryptService implements ServiceSubscriberInterface
{
    ...
    public static function getSubscribedServices(): array
    {
        return [
            ...
            'jwt.token_manager' => '?'.JWTTokenManagerInterface::class,
    ...
    protected function addFlash(string $type, mixed $message): void
    {
        if(!$this->isAPI()){
            ...
            $token?->setAttribute($type, $message);
    ...
    {
        return self::API_FIREWALL === strtolower($this->container->get('security.firewall.map')->getFirewallConfig($this->getRequest())->getName());
    }
